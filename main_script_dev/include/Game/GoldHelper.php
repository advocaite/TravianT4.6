...
class GoldHelper
{
    ...
    public function finishNowButton()
    {
        ...
        if (!$hasPerm) {
            return '<div class="finishNow">' . getButton([
                    "type"    => "button",
                    "class"   => "textButtonV1 gold disabled",
    ...
    public function getGoldClubButton()
    {
        ...
        if ($session->hasGoldClub()) {
            return getButton([
                "type"    => "button",
                "class"   => "textButtonV2 gold prosButton goldclub buttonFramed withText rectangle disabled",
                "onClick" => "if(jQuery(this).hasClass('disabled')){event.stopPropagation(); return false;} else {}",
                "onFocus" => "jQuery('button', 'input[type!=hidden]', 'select').focus(); event.stopPropagation(); return false;",
        ...
        return getButton([
            "type"  => "button",
            "class" => "textButtonV2 gold prosButton goldclub buttonFramed withText rectangle",
            'title' => T("inGame", "plus." . ('activate')),
            'coins' => $config->gold->goldClubGold,
        ],
            [
                "data" => [
                    ...
                    'confirm' => '',
                    'onclick' => '',							
					"version" => "textButtonV2",
					"wayOfPayment" => json_decode('{"featureKey":"goldclub","context":"goldclub"}')
                ],
            ],
            T("inGame", "plus." . ('activate')));
    }
    ...
    public function getPlusButton($infoBox = FALSE, $paymentWizard = FALSE)
    {
        ...
        if (!$hasPerm) {
            return getButton([
                "type"    => "button",
                "class"   => "textButtonV2 gold prosButton plus buttonFramed withText rectangle {$extra} disabled",
                "onClick" => "if(jQuery(this).hasClass('disabled')){event.stopPropagation(); return false;} else {}",
                "onFocus" => "jQuery('button', 'input[type!=hidden]', 'select').focus(); event.stopPropagation(); return false;",
                "title"   => htmlspecialchars('<span class="warning">' . T("inGame",
                        "sitterNoPermForGold") . '</span>'),
        ...
        return getButton([
            "type"  => "button",
            "class" => "textButtonV2 gold prosButton plus buttonFramed withText rectangle {$extra}",
            ...
            [
                "data" => array_merge([
                    ...
                    'onclick' => '',							
					"version" => "textButtonV2",
					"wayOfPayment" => json_decode('{"featureKey":"plus","context":"plus"}')
                ],
                    $data),
            ],
            T("inGame", "plus." . ($hasPlus ? 'extend' : 'activate')));
    ...
    public function renderBuyGoldButton()
    {
        ...
        if (!$hasPerm) {
            return getButton([
                "type"  => "button",
                "class" => "textButtonV1 green disabled",
            ],
                [
                    "data" => [
                        "type"    => "button",
    ...
    public function renderBuyButton($featureKey, $coins, $wwInAvailable, $disabled = false)
    {
        ...
        if ($disabled) {
            return getButton([
                "type"    => "button",
                "class"   => "textButtonV2 gold prosButton buttonFramed withText rectangle " . $featureKey . " disabled",
                "onClick" => "if(jQuery(this).hasClass('disabled')){event.stopPropagation(); return false;} else {}",
                "onFocus" => "jQuery('button', 'input[type!=hidden]', 'select').focus(); event.stopPropagation(); return false;",
                "title"   => $title,
                'coins'   => $coins,
        ...
        return getButton([
            "type"  => "button",
            "class" => "textButtonV2 gold prosButton buttonFramed withText rectangle  " . $featureKey,
            'title' => $text,
            'coins' => $coins,
        ],
            [
    ...
    public function getProductionBoostButton($resourcesId, $infoBox = FALSE, $paymentWizard = FALSE, $production = FALSE)
    {
        ...
        if (!$hasPerm) {
            return getButton([
                "type"    => "button",
                "class"   => "textButtonV2 gold buttonFramed withText rectangle  {$extra} " . ($paymentWizard ? 'productionboost' : 'productionBoostButton ') . "{$resClass} disabled",
                "onClick" => "if(jQuery(this).hasClass('disabled')){event.stopPropagation(); return false;} else {}",
                "onFocus" => "jQuery('button', 'input[type!=hidden]', 'select').focus(); event.stopPropagation(); return false;",
                "title"   => htmlspecialchars('<span class="warning">' . T("inGame",
                        "sitterNoPermForGold") . '</span>'),
        ...
        return getButton([
            "type"  => "button",
            "class" => "textButtonV2 gold buttonFramed withText rectangle {$extra} " . ($paymentWizard ? 'productionboost' : 'productionBoostButton ') . "{$resClass}",
    ...
    public function getMasterBuilderButton($fieldId, $item_id, $lvl, $link)
    {
        ...
        if (!$hasPerm) {
            return getButton([
                "type"    => "button",
                "class"   => "textButtonV1 $class builder disabled",
                "onClick" => "if(jQuery(this).hasClass('disabled')){event.stopPropagation(); return false;} else {}",
                "onFocus" => "jQuery('button', 'input[type!=hidden]', 'select').focus(); event.stopPropagation(); return false;",
                "title"   => htmlspecialchars('<span class="warning">' . T("inGame",
                        "sitterNoPermForGold") . '</span>'),
        ...
        if (!$village->isWW() && $session->getAvailableGold() < $gold) {
            return getButton([
                "type"  => "button",
                "class" => "textButtonV1 $class builder",
                "coins" => $gold,
            ],
                [
                    "data" => [
    ...
    public function getExchangeResourcesButtonByCost($cost)
    {
        ...
        return getButton([
            "type"  => "button",
            "class" => "textButtonV1 gold exchange " . ($disabled ? 'disabled' : ''),
        ],
            [
                "data" => [
                    "dialog" => [
    ...
    private function ExchangeResourcesError()
    {
        ...
        if (!$hasPerm) {
            return getButton([
                "type"    => "button",
                "class"   => "textButtonV1 gold exchange disabled",
                "onClick" => "if(jQuery(this).hasClass('disabled')){event.stopPropagation(); return false;} else {}",
                "onFocus" => "jQuery('button', 'input[type!=hidden]', 'select').focus(); event.stopPropagation(); return false;",
                "title"   => htmlspecialchars('<span class="warning">' . T("inGame",
                        "sitterNoPermForGold") . '</span>'),

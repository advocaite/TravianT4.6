...
<div class="success">The captcha was correct and the message has been sent!  The captcha was solved in <?=$_SESSION['ctform']['timetosolve'] ?> seconds.</div><br />
<?php endif; ?>

...
<div style="font-size:16px;line-height:25px;font-family:Helvetica, sans-serif;color:#666666;direction:<?=getDirection();?>;text-align: <?=(getDirection() == 'LTR' ? 'left' : 'right');?>" class="padding-copy">
    ...
    <br><br> <?=T("Mail", "APPROVED_EMAIL_TO_CONTINUE_INSTRUCTIONS");?>
    <br /><br />
            ...
            <td align="center" style="padding:20px;" class="mobile-button-container">
                <table border="0" cellspacing="0" cellpadding="0" class="mobile-button-container">
                    ...
                    <tr>
                        <td align="center">
                            <div>
                                <a href="<?=Config::getProperty("settings", "gameWorldUrl");?>activate.php?token=<?=$vars['token'];?>" style="font-size:20px;font-family:Helvetica, sans-serif;color:#492208;text-decoration:none;padding:10px;border:0px;" class="mobile-button" target="_blank"><b><?=T("Mail", "Continue Registration Progress");?></b></a></div>
                        </td>
                    </tr>
                    </tbody>
                </table>

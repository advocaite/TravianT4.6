<form method="post" name="post" action="allianz.php">
    ...
    <button type="submit" value="<?=T("Global", "General.ok");?>" name="s1" id="fbtn_ok" class="green ">
    ...
    <script type="text/javascript">
        jQuery(function() {
            if (jQuery('#fbtn_ok')) {
                jQuery('#fbtn_ok').click(function (event) {

            ...
            <?php if($vars['isAllianceAutoType']):?>
                ...
                <div id="answer">
                    <form method="post" action="messages.php">
                        ...
                        <?php if($vars['send'] == 0):?>
                            <button type="submit" value="<?=T("Messages", "Mark as unread");?>" name="toggleState" id="toggleState" class="textButtonV1 green" version="textButtonV1"><?=T("Messages", "Mark as unread");?></button>
                        ...
                        <?php endif;?>
						<button type="submit" value="answer" name="ss" id="ss" class="textButtonV1 green <?=$vars['answerActive'] == 0 ? 'disabled' : '';?>" version="textButtonV1" <?=$vars['answerActive'] == 0 ? ' onClick="return false;"' : '';?>><?=T("Messages", "answer");?></button>
                        <script type="text/javascript">
                            jQuery(function() {
                                if (jQuery('#ss')) {
                                    jQuery('#ss').click(function (event) {
                                        jQuery(window).trigger('buttonClicked', [this, {
                                            ...
                                            "name": "ss",
                                            "id": "ss",
                                            "class": "textButtonV1 green <?=$vars['answerActive'] == 0 ? 'disabled' : '';?>",
                                            "title": "",
                                            "confirm": "",

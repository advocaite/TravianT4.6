                ...
                <div class="paperContent">
                    ...
                    <div id="bbEditor">
                        <div id="notepad_container" class="bbEditor">
                            ...
                            <div id="notepad_preview" class="messageEditor hide preview"></div>
                        </div>
                    ...
                    <div class="btn" id="send">
                        <button type="submit" value="save" name="s1" id="s1" class="textButtonV1 green " version="textButtonV1"><?=T("Global", "General.ok");?></button>
						<script type="text/javascript">
                            jQuery(function() {
                                if (jQuery('#s1')) {

...
<div class="featureCollection" id="featureCollectionWrapper">
	<div class="feature packageFeatures">
		<div class="featureContent">
			<div class="featureImage messageArchive"></div>
			<div class="featureTitle"><?= $vars['features']['messageArchive']['title']; ?></div>
			<div class="featureDescription"><?= $vars['features']['messageArchive']['text']; ?></div>
		</div>
	</div>
	
	<div class="activation">
		<div class="title"><?= $vars['subHeadLine']; ?></div>
		<div class="description"><?= $vars['goldclubPopupButtonExtraFeatures']; ?></div>
	</div>

	<div class="feature packageFeatures">
		<div class="featureContent">
			<div class="featureImage troopEscape"></div>
			<div class="featureTitle"><?= $vars['features']['troopEscape']['title']; ?></div>
			<div class="featureDescription"><?= $vars['features']['troopEscape']['text']; ?></div>
		</div>
	</div>
	<div class="feature packageFeatures">
		<div class="featureContent">
			<div class="featureImage raidList"></div>
			<div class="featureTitle"><?= $vars['features']['raidList']['title']; ?></div>
			<div class="featureDescription"><?= $vars['features']['raidList']['text']; ?></div>
		</div>
	</div>
	<div class="feature packageFeatures">
		<div class="featureContent">
			<div class="featureImage tradeThreeTimes"></div>
			<div class="featureTitle"><?= $vars['features']['tradeThreeTimes']['title']; ?></div>
			<div class="featureDescription"><?= $vars['features']['tradeThreeTimes']['text']; ?></div>
		</div>
	</div>
	<div class="feature packageFeatures">
		<div class="featureContent">
			<div class="featureImage tradeRoute"></div>
			<div class="featureTitle"><?= $vars['features']['tradeRoute']['title']; ?></div>
			<div class="featureDescription"><?= $vars['features']['tradeRoute']['text']; ?></div>
		</div>
	</div>
	<div class="feature packageFeatures">
		<div class="featureContent">
			<div class="featureImage cropFinder"></div>
			<div class="featureTitle"><?= $vars['features']['cropFinder']['title']; ?></div>
			<div class="featureDescription"><?= $vars['features']['cropFinder']['text']; ?></div>
		</div>
	</div>
	
	<div class="feature featureBooking">
		<div class="featureContent goldclub">
			<div class="featureImage goldclub"></div>

<h1 class="titleInHeader"><?= $vars['title']; ?></h1>
<div class="accountBalance">
  <div class="inlineIcon " title="">
	 ...
	 <span class="value ">‭‭<?= $vars['gold']; ?>‬</span>
  </div>
</div>
<div class="featureCollection" id="featureCollectionWrapper">
  <div class="feature packageFeatures">
	 <div class="featureContent">
		<div class="featureImage fullScreen"></div>
		<div class="featureTitle"><?= $vars['features']['fullScreen']['title']; ?></div>
		<div class="featureDescription"><?= $vars['features']['fullScreen']['text']; ?></div>
	 </div>
  </div>
  <div class="activation">
	 <div class="title"><?= $vars['subHeadLine']; ?></div>
	 <div class="description"><?= $vars['plusPopupButtonExtraFeatures']; ?></div>
  </div>
  <div class="feature packageFeatures">
	 <div class="featureContent">
		<div class="featureImage attackWarning"></div>
		<div class="featureTitle"><?= $vars['features']['attackWarning']['title']; ?></div>
		<div class="featureDescription"><?= $vars['features']['attackWarning']['text']; ?></div>
	 </div>
  </div>
  <div class="feature packageFeatures">
	 <div class="featureContent">
		<div class="featureImage buildingQueue"></div>
		<div class="featureTitle"><?= $vars['features']['buildingQueue']['title']; ?></div>
		<div class="featureDescription"><?= $vars['features']['buildingQueue']['text']; ?></div>
	 </div>
  </div>
  <div class="feature packageFeatures">
	 <div class="featureContent">
		<div class="featureImage directLinks"></div>
		<div class="featureTitle"><?= $vars['features']['directLinks']['title']; ?></div>
		<div class="featureDescription"><?= $vars['features']['directLinks']['text']; ?></div>
	 </div>
  </div>
  <div class="feature packageFeatures">
	 <div class="featureContent">
		<div class="featureImage linkList"></div>
		<div class="featureTitle"><?= $vars['features']['linkList']['title']; ?></div>
		<div class="featureDescription"><?= $vars['features']['linkList']['text']; ?></div>
	 </div>
  </div>
  <div class="feature packageFeatures">
	 <div class="featureContent">
		<div class="featureImage villageStatistics"></div>
		<div class="featureTitle"><?= $vars['features']['villageStatistics']['title']; ?></div>
		<div class="featureDescription"><?= $vars['features']['villageStatistics']['text']; ?></div>
	 </div>
  </div>
  <div class="feature packageFeatures">
	 <div class="featureContent">
		<div class="featureImage tradeMulti"></div>
		<div class="featureTitle"><?= $vars['features']['tradeMulti']['title']; ?></div>
		<div class="featureDescription"><?= $vars['features']['tradeMulti']['text']; ?></div>
	 </div>
  </div>
  <div class="feature featureBooking">
	 <div class="featureContent plus">
		<div class="featureImage plus"></div>

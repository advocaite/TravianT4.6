<div id="smallestPackageDialog">
   ...
   <div id="smallestPackageData">
      <input type="radio" id="package1" name="package" value="<?= $vars['goldProductId']; ?>">
      <label for="package1" class="package">
         <div class="inlineIcon amount" title="">
            ...
            <span class="value "><?= $vars['goldNum']; ?></span>
         </div>
         <div class="packageImage">
            <img src="<?= WebService::getPaymentUrl() . 'img/product/' . $vars['goldProductImageName']; ?>" alt="">
         </div>
         <div class="price"><?= $vars['Price']; ?> <?= $vars['goldProductMoneyUnit']; ?><span class="asterisk">*</span></div>
         <div class="changePackage"><?= T("PaymentWizard", "Change"); ?></div>
      </label>
   </div>
   <div class="buy">
      <button type="button" value="<?= T("PaymentWizard", "Buy gold"); ?>" id="buySmallestPackage" class="textButtonV2 green  buttonFramed withText rectangle" onclick="Travian.WindowManager.closeByContext('smallestPackage'); jQuery(window).trigger('startPaymentWizard', {data:{goldProductId: '<?=$vars['goldProductId'];?>', activeTab: 'buyGold'}}); return false;" version="textButtonV2">
         <div>
            <?= T("PaymentWizard", "Buy gold"); ?>	
         </div>
      </button>
      <script type="text/javascript" id="buySmallestPackage_script">
         jQuery(function() {
                jQuery('button#buySmallestPackage').click(function () {
                    jQuery(window).trigger('buttonClicked', [this, {"type":"button","value":"Buy Gold","name":"","id":"buySmallestPackage","class":"textButtonV2 green  buttonFramed withText rectangle","title":"<?=T("PaymentWizard", "Buy gold");?>","confirm":"","onclick":"Travian.WindowManager.closeByContext(\u0027smallestPackage\u0027); jQuery(window).trigger(\u0027startPaymentWizard\u0027, {data:{goldProductId: \u002742798f2d-9ef1-4f30-b109-22212161f521\u0027, activeTab: \u0027buyGold\u0027}}); return false;","version":"textButtonV2"}]);
                });
         });
      </script>
   </div>
   <div class="changeGoldPackage">
      <a href="#" onclick="Travian.WindowManager.closeByContext('smallestPackage'); jQuery(window).trigger('startPaymentWizard', {data:{goldProductId: '', activeTab: 'buyGold'}}); return false;">
      <?= T("PaymentWizard", "ChooseAnotherPackage"); ?></a>
   </div>
</div>
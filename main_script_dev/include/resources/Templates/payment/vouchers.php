...
<div class="purchaseStepWrapper">
   ...
   <div class="voucherForm">
      ...
      <button type="submit" value="<?= T("PaymentWizard", "Redeem"); ?>" id="redeemVoucher" class="textButtonV2 green  disabled buttonFramed withText rectangle" onclick="if(jQuery(this).hasClass('disabled')){event.stopPropagation(); return false;} else {}" version="textButtonV2" onfocus="jQuery('button', 'input[type!=hidden]', 'select').focus(); event.stopPropagation(); return false;">
         <div>
            <?= T("PaymentWizard", "Redeem"); ?>	
         </div>
      </button>
      <script type="text/javascript" id="redeemVoucher_script">
         jQuery(function() {
                jQuery('button#redeemVoucher').click(function () {
                    jQuery(window).trigger('buttonClicked', [this, {"type":"submit","value":"<?= T("PaymentWizard", "Redeem"); ?>","name":"","id":"redeemVoucher","class":"textButtonV2 green  disabled buttonFramed withText rectangle","title":"","confirm":"","onclick":"if(jQuery(this).hasClass(\u0027disabled\u0027)){event.stopPropagation(); return false;} else {}","version":"textButtonV2","onfocus":"jQuery(\u0027button\u0027, \u0027input[type!=hidden]\u0027, \u0027select\u0027).focus(); event.stopPropagation(); return false;"}]);
                });
         });
      </script>
   </div>
   <div class="packages">
      ...
      <label for="package1" class="package      ">
         ...
         <div class="packageImage">
            <img src="/img/x.gif" alt="" class="fallbackPackageImage">
         </div>
         <div class="changePackage"><?= T("PaymentWizard", "Change"); ?></div>
      </label>
   </div>
   <div class="confirmation success">
      <div class="confirmationTitle"><?= T("PaymentWizard", "Voucher confirmed"); ?></div>
      <div class="confirmationImage"></div>
      <div class="confirmationText">
         <span class="value">-</span> <?= T("PaymentWizard", "Gold added to your account."); ?>          
      </div>
   </div>
</div>

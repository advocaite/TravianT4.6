...
?>
<input type="radio" id="package<?=$value['goldProductId'];?>" name="package" value="<?=$value['goldProductId'];?>">
<label for="package<?=$value['goldProductId'];?>" class="package <?=($value['isBestSeller'] == 1 || $value['isBestValue'] == 1)?'bestPackage':'';?>">
	<?php 
	if($value['isBestSeller'] == 1 || $value['isBestValue'] == 1):?>
	<div class="best <?=($value['isBestSeller']?'bestSeller':($value['isBestValue']?'bestValue':''));?>">
		<div class="text"><?=($value['isBestSeller']?T("PaymentWizard", "Best Seller"):($value['isBestValue']?T("PaymentWizard", "Best Value"):''));?></div>
	</div>
	<?php endif;?>
   <div class="inlineIcon amount" title="">
	  ...
	  <span class="value "><?=$value['goldProductGold'];?></span>
   </div>
   <div class="packageImage">
	  <img src="<?=WebService::getPaymentUrl() . 'img/product/' . $value['goldProductImageName'];?>" alt="">
   </div>
   <div class="price"><?=$price;?><span class="asterisk">*</span></div>

<div id="paymentWizard" class="<?php echo $vars['class']; ?> selectPackage">
   <input class="paymentWizardAnswersLink hide" type="hidden" name="answersLink" value="<?=getAnswersUrl(); ?>aid=<?=$vars['answerId']; ?>#go2answer">
   <div class="accountBalance">
      <div class="inlineIcon " title="">
         ...
         <span class="value ajaxReplaceableGoldAmount">‭
			<?=$vars['gold'];?>
		‬</span>
      </div>
   </div>
   <div class="header">
      <div class="contentNavi subNavi">
         <div class="scrollingContainer">
            <div class="content <?=$vars['class'] == 'buyGold' ? 'active': '';?>"><a href="#" class="tabItem buyGold" data-tabname="buyGold">
               <span><?=T("PaymentWizard", "Buy gold"); ?></span>
               </a>
            </div>
            <div class="content <?=$vars['class'] == 'earnGold' ? 'active': '';?>"><a href="#" class="tabItem earnGold" data-tabname="earnGold">
               <span><?=T("PaymentWizard", "Earn Gold"); ?></span>
               </a>
            </div>
			<?php if(getDisplay("showVouchersTab")): ?>
            <div class="content <?=$vars['class'] == 'vouchers' ? 'active': '';?>"><a href="#" class="tabItem vouchers" data-tabname="vouchers">
               <span><?=T("PaymentWizard", "Vouchers"); ?></span>
               </a>
            </div>
			<?php endif;?>
            <div class="content <?=$vars['class'] == 'pros' ? 'active': '';?>"><a href="#" class="tabItem pros" data-tabname="pros">
               <span><?=T("PaymentWizard", "Advantages"); ?></span>
               </a>
            </div>
			<?php if($vars['plusFeaturesEnabled']): ?>
            <div class="content <?=$vars['class'] == 'paymentFeatures' ? 'active': '';?>"><a href="#" class="tabItem paymentFeatures" data-tabname="paymentFeatures">
               <span><?=T("PaymentWizard", "paymentFeatures"); ?></span>
               </a>
            </div>
			<?php endif;?>
			<?php if(getDisplay("showPlusSupportTab")): ?>
            <div class="content <?=$vars['class'] == 'plusSupport' ? 'active': '';?>"><a href="#" class="tabItem plusSupport buyGold" data-tabname="plusSupport">
               <span><?=T("PaymentWizard", "Plus Support"); ?></span>
               </a>
            </div>
			<?php endif;?>
         </div>

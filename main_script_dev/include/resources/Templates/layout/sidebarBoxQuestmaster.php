<div id="sidebarBoxQuestmaster" class="sidebarBox   ">
        <div class="header ">
			...
			<script type="text/javascript" data-cmp-info="6"> jQuery(function(){jQuery('button#questmasterButton').click(function(){window.location='/tasks';});});</script>
        ...
        <div class="content">
			<a href="/tasks" class="progressiveTasksTitle">
				<div class="boxTitle"><?=T("Quest", "taskList");?></div>
			</a>
            <?php 
                    ...
                    foreach ($vars['data'] as $type => $task) {
                        foreach ($task['quests'] as $quest) {
                            foreach ($quest['steps'] as $step) {
                                ...
                                echo '<a href="#" class="quest">' . T("Quest", explode(".", $quest['name'])[1]) . '</a>';
                                echo '</li>';
                            }
                        }
                    }

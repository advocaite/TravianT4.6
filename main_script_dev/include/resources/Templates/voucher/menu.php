<div class="contentNavi subNavi tabFavorWrapper">
    ...
    <div class="scrollingContainer">
		<div class="content" > 
			<a id="<?=$button_id = get_button_id();?>" href="voucher.php?t=0" class="tabItem <?=$vars['selectedTab'] == 0 ? 'active' : 'normal'; ?>" > 
				<?= T("PaymentWizard", "Use voucher"); ?>
			</a> 
		</div>
		<script type="text/javascript">if (jQuery('#<?=$button_id;?>')){jQuery('#<?=$button_id;?>').click(function (event){jQuery(window).trigger('tabClicked', [this,{"class": "<?=$vars['selectedTab'] == 1 ? 'active' : 'normal';?>", "title": false, "target": false, "id": "<?=$button_id;?>", "href": "voucher.php?t=0", "onclick": false, "enabled": true, "text": "<?= T("PaymentWizard", "Use voucher"); ?>", "dialog": false, "plusDialog": false, "goldclubDialog": false, "containerId": "", "buttonIdentifier": "<?=$button_id;?>"}]);});}</script> 
		
		<div class="content" > 
			<a id="<?=$button_id = get_button_id();?>" href="voucher.php?t=2" class="tabItem <?=$vars['selectedTab'] == 2 ? 'active' : 'normal'; ?>" > 
				<?= T("PaymentWizard", "Vouchers"); ?>
			</a> 
		</div>
		<script type="text/javascript">if (jQuery('#<?=$button_id;?>')){jQuery('#<?=$button_id;?>').click(function (event){jQuery(window).trigger('tabClicked', [this,{"class": "<?=$vars['selectedTab'] == 2 ? 'active' : 'normal';?>", "title": false, "target": false, "id": "<?=$button_id;?>", "href": "voucher.php?t=2", "onclick": false, "enabled": true, "text": "<?= T("PaymentWizard", "Vouchers"); ?>", "dialog": false, "plusDialog": false, "goldclubDialog": false, "containerId": "", "buttonIdentifier": "<?=$button_id;?>"}]);});}</script> 
		
		<div class="content"> 
			<a id="<?=$button_id = get_button_id();?>" href="voucher.php?t=1" class="tabItem <?=$vars['selectedTab'] == 1 ? 'active' : 'normal'; ?>" > 
				<?= T("PaymentWizard", "History"); ?>
			</a> 
		</div>
		<script type="text/javascript">if (jQuery('#<?=$button_id;?>')){jQuery('#<?=$button_id;?>').click(function (event){jQuery(window).trigger('tabClicked', [this,{"class": "<?=$vars['selectedTab'] == 1 ? 'active' : 'normal';?>", "title": false, "target": false, "id": "<?=$button_id;?>", "href": "voucher.php?t=1", "onclick": false, "enabled": true, "text": "<?= T("PaymentWizard", "History"); ?>", "dialog": false, "plusDialog": false, "goldclubDialog": false, "containerId": "", "buttonIdentifier": "<?=$button_id;?>"}]);});}</script> 
		
		<div class="content" > 
			<a id="<?=$button_id = get_button_id();?>" href="voucher.php?t=3" class="tabItem <?=$vars['selectedTab'] == 3 ? 'active' : 'normal'; ?>" > 
				<?= T("TransferGold", "title"); ?>
			</a> 
		</div>
		<script type="text/javascript">if (jQuery('#<?=$button_id;?>')){jQuery('#<?=$button_id;?>').click(function (event){jQuery(window).trigger('tabClicked', [this,{"class": "<?=$vars['selectedTab'] == 3 ? 'active' : 'normal';?>", "title": false, "target": false, "id": "<?=$button_id;?>", "href": "voucher.php?t=3", "onclick": false, "enabled": true, "text": "<?= T("TransferGold", "title"); ?>", "dialog": false, "plusDialog": false, "goldclubDialog": false, "containerId": "", "buttonIdentifier": "<?=$button_id;?>"}]);});}</script> 
	</div>

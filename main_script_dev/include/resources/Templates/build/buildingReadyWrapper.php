...
<?php else: ?>
    <div class="upgradeHeader">
	   <a onclick="Travian.Game.Manual.open('building', 4);"><img class="buildingIllustration g<?= $vars['itemId']; ?> <?= $vars['raceName']; ?> " alt="<?= T("Buildings", $vars['itemId'] . '.title'); ?>" src="/img/x.gif" data-cmp-info="9"></a>
	...
	<div class="buildingDescription ">
	   <div class="headline">
		  ...
		  <h4><?= T("Global", "General.description"); ?></h4>
	   </div>
	   <div class="description"><?= T("Buildings", $vars['itemId'] . '.desc'); ?></div>
	</div>
    ...
    <?php endif; ?>
	<div class="upgradeBuilding <?= !$vars['showCosts']?"completed":""; ?>">
    <?php if (!$vars['showCosts']): ?>

...
class AdventureModel
{
    ...
    {
        $db = DB::getInstance();
        $result = $db->query("SELECT COUNT(id) AS `count`, time FROM adventure WHERE uid=$uid AND end=0 ORDER BY id ASC LIMIT 1");
    ...
    public function getAdventures($uid)
    {
        ...
        return $db->query("SELECT * FROM adventure WHERE uid=$uid " . " ORDER BY id ASC");

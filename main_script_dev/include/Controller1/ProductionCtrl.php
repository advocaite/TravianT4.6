...
class ProductionCtrl extends GameCtrl
{
    ...
    public function __construct()
    {
		...
		$this->view->vars['answerId'] = 365;
		
		switch($this->tabIndex){
			case 1: $this->view->vars['contentCssClass'] .= 'productionLumber';
			break;
			case 2: $this->view->vars['contentCssClass'] .= 'productionClay';
			break;
			case 3: $this->view->vars['contentCssClass'] .= 'productionIron';
			break;
			case 4: $this->view->vars['contentCssClass'] .= 'productionCrop';
			break;
			case 5: $this->view->vars['contentCssClass'] .= 'productionBalance';
			break;
		}

...
class NachrichtenCtrl extends GameCtrl
{
    ...
    public function __construct()
    {
        ...
        $this->view->vars['bodyCssClass'] = "perspectiveBuildings messages";
        $this->view->vars['contentCssClass'] = "messages messagesInbox";
        ...
        $view->vars['favorTabId'] = Session::getInstance()->getFavoriteTab("messages");

...
//   }
$db = DB::getInstance();
$queryVariable = Session::getInstance()->getPlayerId();
$beard1 = $_POST['beard'];
$headProfile1 = $_POST['headProfile'];
$hairColor1=$_POST['hairColor'];
$hairStyle1=$_POST['hairStyle'];
$ears1=$_POST['ears'];
$eyebrow1=$_POST['eyebrow'];
$eyes1=$_POST['eyes'];
$nose1=$_POST['nose'];
$mouth1=$_POST['mouth'];
$gender1=$_POST['gender'];
$horse1=$_POST['horse'];
$helmet1=$_POST['helmet'];
$body1=$_POST['body'];
$shoes1=$_POST['shoes'];
$leftHand1=$_POST['leftHand'];
$rightHand1=$_POST['rightHand'];
$bag1=isset($_POST['bag']) ? $_POST['bag'] : "";

$TempArray1 = $db->query("UPDATE inventory SET horse=$horse1, helmet=$helmet1, body=$body1, leftHand=$leftHand1, rightHand=$rightHand1, shoes=$shoes1  WHERE uid=$queryVariable");

 
$TempArray = $db->query("UPDATE face SET beard=$beard1, headProfile=$headProfile1, hairColor=$hairColor1, hairStyle=$hairStyle1, ears=$ears1, eyebrow=$eyebrow1, eyes=$eyes1, nose=$nose1, mouth=$mouth1, gender='$gender1' WHERE uid=$queryVariable");
    ...
    public function __construct()
    {
        ...
        $view->vars['hero'] = array_merge($hero->hero,
           ...
           // $view->vars['HealthTitle'] = $hero->getHealthTitle($inventory);
            ...
            $view->vars['HeroEquipments'] = json_encode($hero->getHeroEquipments(), JSON_PRETTY_PRINT);

...
class StatistikenCtrl extends GameCtrl
{
    ...
    public function __construct()
    {
        ...
        $this->view->vars['bodyCssClass'] = 'perspectiveResources statistics';
		...
		$this->view->vars['answerId'] = 112;
		switch($selectedTabIndex){
			case 0: 
			$this->view->vars['contentCssClass'] .= ' statisticsPlayer'; 		
			break;
			case 1: 
			$this->view->vars['contentCssClass'] .= ' statisticsAlliance'; 
			break;
			case 2: 
			$this->view->vars['contentCssClass'] .= ' statisticsVillage'; 
			break;
			case 3: 
			$this->view->vars['contentCssClass'] .= ' statisticsHero'; 
			break;
			case 5: 
			$this->view->vars['contentCssClass'] .= ' statisticsGeneral'; 
			break;
			case 6:
			$this->view->vars['contentCssClass'] .= ' statisticsWonderoftheworld'; 
			break;
    ...
    public function handle($selectedTabIndex, $selectedSubIndex)
    {
        switch ($selectedTabIndex) {
            ...
            case 5:
                ...
                */
                return $this->processGeneralOverview($selectedTabIndex, $selectedSubIndex);
                break;
            case 6:
                $statistics = new StatisticsModel();
    ...
    private function processGeneralOverview($selectedTabIndex, $selectedSubIndex)
    {
        $statistics = new StatisticsModel();
        $selectedRank = 0;
...
<tr class="{$class}">
			<td class="ra " style="background-image: linear-gradient(to bottom,silver,silver 1px,rgba(192,192,192,0) 1px);padding: 6px 9px 3px;">{$rank}.</td>
			<td class="tribe "><i class="tribe3_medium" style="background-image: url(../../gpack/29c89d54/mainPage/img_ltr/general/tribes/gaul_medium.png);
    width: 22px;
    height: 22px;padding: 6px 9px 3px;"></i></td>
            <td class="pla " style="background-image: linear-gradient(to bottom,silver,silver 1px,rgba(192,192,192,0) 1px);padding: 6px 9px 3px;"><a href="spieler.php?uid={$row['id']}">{$row['name']}</a> </td>
			<td class="al " style="background-image: linear-gradient(to bottom,silver,silver 1px,rgba(192,192,192,0) 1px);padding: 6px 9px 3px;">$alliance</td>
			{$flag}
			<td class="pop " style="background-image: linear-gradient(to bottom,silver,silver 1px,rgba(192,192,192,0) 1px);padding: 6px 9px 3px;">{$row['total_population']}</td>
			<td class="vil " style="background-image: linear-gradient(to bottom,silver,silver 1px,rgba(192,192,192,0) 1px);padding: 6px 9px 3px;">{$row['total_villages_count']}</td>
			{$admin}
		</tr>
HTML;
        }
        return PHPBatchView::render('statistics/table',
			...
			' . (Session::getInstance()->isAdmin() ? '<td class="buttons" style="padding: 2px 0 2px 2px;white-space: nowrap;width: 1%;">' . T("Statistics",
                            "Actions") . '</td>' : '') . '
		',
                "headerRound" => T("Statistics", "The largestPlayers"),
                "http_query" => !sizeof($prefix) ? '' : "?" . http_build_query($prefix),
                "tableBody" => $tableBody,
                "Navigator" => $nav->get(),
                "selectedRank" => isset($_REQUEST['rank']) ? $_REQUEST['rank'] : $selectedRank,
...
HTML;
        ...
        return PHPBatchView::render("statistics/table",
			...
			<td>' . T("Statistics", "points") . '</td>
                ...
                "headerRound" => T("Statistics", "The largestPlayers") . ' (' . T("Statistics",
...
<tr class="{$class}">
			...
			<td class="ra " style="background-image: linear-gradient(to bottom,silver,silver 1px,rgba(192,192,192,0) 1px);padding: 6px 9px 3px;">{$rank}.</td>
			<td class="al " style="background-image: linear-gradient(to bottom,silver,silver 1px,rgba(192,192,192,0) 1px);padding: 6px 9px 3px;"><a href="allianz.php?aid={$row['id']}">{$row['tag']}</a> </td>
			<td class="pla " style="background-image: linear-gradient(to bottom,silver,silver 1px,rgba(192,192,192,0) 1px);padding: 6px 9px 3px;">{$row['memcount']}</td>
			<td class="avg "style="background-image: linear-gradient(to bottom,silver,silver 1px,rgba(192,192,192,0) 1px);padding: 6px 9px 3px;" >{$avg}</td>
			<td class="po " style="background-image: linear-gradient(to bottom,silver,silver 1px,rgba(192,192,192,0) 1px);padding: 6px 9px 3px;">{$row['points']}</td>
			{$admin}
		</tr>
HTML;
        }
        ...
        return PHPBatchView::render('statistics/table',
			...
			' . (Session::getInstance()->isAdmin() ? '<td class="buttons">' . T("Statistics",
                ...
                "headerRound" => T("Statistics", "The largestAlliances"),
                "http_query" => !sizeof($prefix) ? '' : "?" . http_build_query($prefix),
                "tableBody" => $tableBody,
                "Navigator" => $nav->get(),
                "selectedRank" => isset($_REQUEST['rank']) ? $_REQUEST['rank'] : $selectedRank,
...
<tr class="{$class}">
			...
			<td class="ra " style="background-image: linear-gradient(to bottom,silver,silver 1px,rgba(192,192,192,0) 1px);padding: 6px 9px 3px;" >{$rank}.</td>
			<td class="vil " style="background-image: linear-gradient(to bottom,silver,silver 1px,rgba(192,192,192,0) 1px);padding: 6px 9px 3px;"><a href="karte.php?d={$row['kid']}">{$row['name']}</a> </td>
			<td class="pla " style="background-image: linear-gradient(to bottom,silver,silver 1px,rgba(192,192,192,0) 1px);padding: 6px 9px 3px;"><a href="spieler.php?uid={$row['owner']}">{$row['player_name']}</a></td>
			<td class="hab " style="background-image: linear-gradient(to bottom,silver,silver 1px,rgba(192,192,192,0) 1px);padding: 6px 9px 3px;">{$row['pop']}</td>
			<td class="coords"style="background-image: linear-gradient(to bottom,silver,silver 1px,rgba(192,192,192,0) 1px);padding: 6px 9px 3px;" >$coords</td>
		</tr>
HTML;
        }
        ...
        return PHPBatchView::render('statistics/table',
            [
                ...
                "tableColumns" => '<tr>
			<td></td>
			<td>' . T("Statistics", "Villages") . '</td>
			<td>' . T("Statistics", "Player") . '</td>
			<td>' . T("Statistics", "Population") . '</td>
			<td>' . T("Statistics", "Coordinates") . '</td>
		</tr>',
                "headerRound" => T("Statistics", "The largestVillages"),
                "http_query" => !sizeof($prefix) ? '' : "?" . http_build_query($prefix),
                "tableBody" => $tableBody,
                "Navigator" => $nav->get(),
                "selectedRank" => isset($_REQUEST['rank']) ? $_REQUEST['rank'] : $selectedRank,
...
<tr class="{$class}">
			...
			<td class="ra " style="background-image: linear-gradient(to bottom,silver,silver 1px,rgba(192,192,192,0) 1px);padding: 6px 9px 3px;">{$rank}.</td>
			<td class="pla " style="background-image: linear-gradient(to bottom,silver,silver 1px,rgba(192,192,192,0) 1px);padding: 6px 9px 3px;"><a href="spieler.php?uid={$row['uid']}">{$row['player_name']}</a> </td>
			<td class="lev " style="background-image: linear-gradient(to bottom,silver,silver 1px,rgba(192,192,192,0) 1px);padding: 6px 9px 3px;">$level</td>
			<td class="xp " style="background-image: linear-gradient(to bottom,silver,silver 1px,rgba(192,192,192,0) 1px);padding: 6px 9px 3px;">{$row['exp']}</td>
		</tr>
HTML;
        }
        ...
        return PHPBatchView::render('statistics/table',
			...
			<td>' . T("Statistics", "xp") . '</td>
                ...
                "headerRound" => T("Statistics", "The most exp heros"),
                "http_query" => !sizeof($prefix) ? '' : "?" . http_build_query($prefix),
                "tableBody" => $tableBody,
                "Navigator" => $nav->get(),
                "selectedRank" => isset($_REQUEST['rank']) ? $_REQUEST['rank'] : $selectedRank,

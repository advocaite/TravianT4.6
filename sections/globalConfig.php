...
$globalConfig['staticParameters']['indexUrl'] = 'https://www.example.com/';
$globalConfig['staticParameters']['forumUrl'] = 'https://forum.example.com/';
$globalConfig['staticParameters']['answersUrl'] = 'https://answers.travian.com/index.php';
$globalConfig['staticParameters']['helpUrl'] = 'https://help.example.com/';

...
class __TwigTemplate_3d30ea0269806a9fb32eb1922485be649d2a49e0210dee70a14412c1c140b0f2 extends Twig_Template
{
...
<div class=\"mj-container\" style=\"background-color:#FFFFFF;\"><!--[if mso | IE]>
    ...
    <div style=\"margin:0px auto;max-width:600px;background:#ECECEC;\">
        ...
        // line 119
        echo sprintf(call_user_func_array($this->env->getFunction('T')->getCallable(), array("registrationComplete.thankYouForRegisteringOn")), ($context["WORLD_ID"] ?? null));
        echo "</span>
                                        </h1></div>
                                </td>
                            </tr>
        ...
        echo ": ";
        echo twig_escape_filter($this->env, ($context["PLAYER_NAME"] ?? null), "html", null, true);
        echo "</span></p>
                                        <p><span style=\"font-size:16px;\">";
        // line 133
        ...
        echo ": <a
                                                        href=\"";
        // line 135
        echo twig_escape_filter($this->env, ($context["GAME_WORLD_URL"] ?? null), "html", null, true);
        echo "\">";
        echo twig_escape_filter($this->env, ($context["GAME_WORLD_URL"] ?? null), "html", null, true);
        echo "</a></span></p>
                                    </div>
    ...
    {
        return new Twig_Source("", "mail/registrationComplete.twig", "/home/travian_global/users/turbotra/public_subdomains/api/include/Templates/mail/registrationComplete.twig");
    }
}

...
/* mail/en-US/forgottenWorlds.twig */
class __TwigTemplate_ea8e9e6bec8033b32bf86ea1afa14c26a10674ae54310e3235813cccd28ac7e5 extends Twig_Template
{
...
<div class=\"mj-container\" style=\"background-color:#FFFFFF;\"><!--[if mso | IE]>
    ...
    <div style=\"margin:0px auto;max-width:600px;background:#ECECEC;\">
                                ...
                                <td style=\"word-wrap:break-word;font-size:0px;padding:0px 20px 0px 20px;\"
                                    ...
                                    <div style=\"cursor:auto;color:#000000;font-family:Merriweather, Georgia, serif;font-size:10px;line-height:22px;text-align:center;\">
                                        <h1 style=\"font-family: &apos;Merriweather&apos;, Georgia, serif; font-size: 32px; color: #4E4E4E; line-height: 100%;\">
                                            <span style=\"font-size:22px;\">You have requested a search for your game world.</span>
                                        </h1></div>
                                </td>
                            </tr>
                            <tr>
                                <td style=\"word-wrap:break-word;font-size:0px;padding:0px 43px 0px 43px;\" align=\"left\">
                                    <div style=\"cursor:auto;color:#000000;font-family:Merriweather, Georgia, serif;font-size:10px;line-height:22px;text-align:left;\">
                                        <p><span style=\"font-size:16px;\">We&apos;ve searched our game worlds for your email address and found the following accounts. To log in, just click on the game world. </span>
                                        </p>
                                        <p></p></div>
                                </td>
                            </tr>
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["gameWorlds"]) ? $context["gameWorlds"] : null));
        foreach ($context['_seq'] as $context["_key"] => $context["gameWorld"]) {
            // line 136
            echo "                                            <span style=\"font-size:16px;\">Game world: ";
            echo twig_escape_filter($this->env, $this->getAttribute($context["gameWorld"], "worldId", array()), "html", null, true);
            echo "</span>
                                            <br/>
                                            <span style=\"font-size:16px;\">Account name: ";
            // line 138
            echo twig_escape_filter($this->env, $this->getAttribute($context["gameWorld"], "username", array()), "html", null, true);
            echo "</span>
                                            <br/>
                                            <span style=\"font-size:16px;\">Game world link: ";
            // line 140
            echo twig_escape_filter($this->env, $this->getAttribute($context["gameWorld"], "gameWorldUrl", array()), "html", null, true);
            echo "</span>
                                            <hr>
                                        ";
        }
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['gameWorld'], $context['_parent'], $context['loop']);
        ...
        echo "                                    </div>
                            ...
                            <tr>
                                <td style=\"word-wrap:break-word;font-size:0px;padding:34px 20px 34px 20px;\"
                                    align=\"left\">
                                    <div style=\"cursor:auto;color:#949494;font-family:Merriweather, Georgia, serif;font-size:10px;line-height:22px;text-align:left;\">
    ...
    {
        return "mail/en-US/forgottenWorlds.twig";
    }
    ...
    {
        return array (  185 => 143,  176 => 140,  171 => 138,  165 => 136,  161 => 135,  130 => 107,  124 => 104,  19 => 1,);
    }
    ...
    {
        return new Twig_Source("", "mail/en-US/forgottenWorlds.twig", "/home/turbocom/public_html/api/include/Templates/mail/en-US/forgottenWorlds.twig");
    }
}
